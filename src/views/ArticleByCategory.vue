<template>
  ...
  <div v-if="detail">
    <div class="h-56" v-bind:style="{'background-image': 'url(' + detail.thumbnail.desktop + ')'}">
      <div class="flex-col flex justify-center items-center bg-gray-800 h-full bg-opacity-75">
      ...
      <div class="grid grid-cols-12 gap-10 mt-10">
        ...
        <div class="col-span-4">
          ...
          <div v-if="newArticles">
            <h2 class="text-center font-bold p-2 text-2xl mb-5 bg-green-600 text-white">Artikel Terbaru</h2>
